<template>
  <div id="content1">
    ...
    <div class="content_all">
      <img :src="webdata.productList[1].pic" alt />
      <div class="content_cont">
        <h1>{{webdata.title}}</h1>
        <p>{{webdata.productList[0].title2}}</p>
      </div>
    </div>
    <div class="content_price">
      <span class="content_span1">{{webdata.productList[0].strong}}</span>
      <span class="content_span2">元</span>
      <span class="content_span3">{{webdata.shopprice3}}</span>
    ...
    <div class="service">
      ...
      <!-- <i class="iconfont">&#xe63f;</i> -->
      <i class="iconfont">&#xe639;</i>
      <span class="ser_s2">{{webdata.address}}{{webdata.productList[0].strong3}}</span>
    </div>
    <div class="appraise">
...
export default {
  ...
  methods: {
    rundata: function () {
      this.$router.push('/submit8')
      this.$nextTick(function () {
        Bus.$emit('contentdata', this.webdata.productList[0])
      })
    }
  }
}
