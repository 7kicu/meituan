<template>
  <div id="content1">
    ...
    <div class="content_price">
      <span class="content_span1">{{webdata.money2}}</span>
      <span class="content_span2">元</span>
      <span class="content_span3">门市价:{{webdata.money1}}</span>
    ...
    <div class="service">
      ...
      <!-- <i class="iconfont">&#xe63f;</i> -->
      <i class="iconfont">&#xe639;</i>
      <span class="ser_s2">{{webdata.tit2}}</span>
    </div>
    <div class="appraise">
