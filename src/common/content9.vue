<template>
  <div id="content1">
    ...
    <div class="content_all">
      <img :src="webdata.productList[0].thunmb" alt />
      <div class="content_cont">
        <h1>{{webdata.title}}</h1>
        <p>{{webdata.productList[0].taocan}}</p>
      </div>
    </div>
    <div class="content_price">
      <span class="content_span1">{{webdata.productList[0].shopprice}}</span>
      <span class="content_span2">元</span>
      <span class="content_span3">{{webdata.productList[0].shopprice3}}</span>
